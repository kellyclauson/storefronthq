...
public class App
{
   ...
   private WebClient createClient()
   {
      ...
      conduit.getAuthorization().setUserName("a09fe28c9e42fdd6133b6810fe023297");
      conduit.getAuthorization().setPassword("f167d69ee987e652b77998df2d2caf41");
      return client;
   }
   ...
   */
   ...
   private static void getAccessToken()
   {
      ...
      try
      {
         String key = "mwnokgdpwfqx5069esfb4v21";
         String secret = "pnrakqlviv";
         String tokenKey = "4b626dc0090a0462e23efe9b5c08df";
         String tokenSecret = "ee582c9bca";
   ...
   public static void listings() throws IOException
   {
      ...
      String key = "mwnokgdpwfqx5069esfb4v21";
      String secret = "pnrakqlviv";
      String tokenKey = "c475948a5effc0e5928cd448e15b6f";
      String tokenSecret = "2111299970";
